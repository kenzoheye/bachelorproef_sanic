...
WG_BE_PHOENIX_AUT = os.environ.get('WG_BE_PHOENIX_AUT') or 'wg-be-phoenix-aut'
WG_BE_PHOENIX_AUZ = os.environ.get('WG_BE_PHOENIX_AUZ') or 'wg-be-phoenix-auz'
WG_BE_API_CAR = os.environ.get('WG_BE_API_CAR') or 'wg-be-api-car'
WG_BE_PHOENIX_MAIN = os.environ.get('WG_BE_PHOENIX_MAIN') or "wg-be-phoenix-main"
